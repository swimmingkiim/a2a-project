...
gcloud run deploy $SERVICE_NAME \
  ...
  --set-env-vars="NODE_ENV=production,INSTANCE_CONNECTION_NAME=$INSTANCE_CONNECTION_NAME,DB_NAME=agent_db,DB_USER=agent_user,DID_NETWORK=base,RPC_URL=https://mainnet.base.org,GRANT_TOKEN_ADDRESS=0xE0Bf7CE4379E88768A8515E126Abf61C2C7b2Cf2" \
