...
COMP_TOKEN_ADDRESS="0x1F478c3F6a09c3820baBd3f6DCD8bEA4eE5dc806"
...
gcloud run deploy $SERVICE_NAME \
  ...
  --set-env-vars="NODE_ENV=$NODE_ENV,RPC_URL=$RPC_URL,MARKUP_RATE=1.5,COMP_TOKEN_ADDRESS=$COMP_TOKEN_ADDRESS,FEE_TOKEN_ADDRESS=$USDC_TOKEN_ADDRESS,FEE_AMOUNT=$FEE_AMOUNT,ETH_PRICE_USD=$ETH_PRICE_USD,DISABLE_PAYMASTER=false,MIN_SIGNER_BALANCE_ETH=0.01$DB_ENV_VARS" \
