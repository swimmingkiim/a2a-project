...
This document provides important legal information regarding the **Compute Token ($COMP)** and the **A2A (Agent-to-Agent) Platform**. Please read this carefully before using, deploying, or interacting with the project.
...
"A2A", "Compute Token", and "$COMP" may be trademarks or service marks. Use of these marks must comply with applicable trademark laws.
